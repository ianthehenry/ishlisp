...
class Tests(unittest.TestCase):
    ...
    def test_defaulted_patterns(self):
        ...
        self.assertEqual(scope.identifiers(), set(['a', 'b']))
        self.assertEqual(scope.get('a'), 10)
        self.assertEqual(scope.get('b'), nil)
        self.assertFalse(pattern.match(isheval('1'), scope))
        ...
        pattern = isheval('(pattern [a b = 20 3])')
        scope = Scope({}, None)
        self.assertTrue(pattern.match(isheval('[1 2 3]'), scope))
        self.assertEqual(scope.identifiers(), set(['a', 'b']))
        self.assertEqual(scope.get('a'), 1)
        ...
        self.assertEqual(scope.get('b'), 2)
        scope = Scope({}, None)
        self.assertTrue(pattern.match(isheval('[1 nil nil]'), scope))
        self.assertEqual(scope.identifiers(), set(['a', 'b']))
        self.assertEqual(scope.get('a'), 1)
        self.assertEqual(scope.get('b'), nil)
    ...
    def test_cons_pattern_match_list(self):
        ...
        pattern = isheval('(pattern nil:nil')
        scope = Scope({}, None)
        self.assertTrue(pattern.match(isheval('nil:nil'), scope))
        self.assertEqual(scope.identifiers(), set([]))

        pattern = isheval('(pattern nil:nil:nil:nil')
        scope = Scope({}, None)
        self.assertTrue(pattern.match(isheval('nil:nil:nil:nil'), scope))
        self.assertEqual(scope.identifiers(), set([]))

        pattern = isheval('(pattern nil:a')
        scope = Scope({}, None)
        self.assertTrue(pattern.match(isheval('nil:1'), scope))
        self.assertEqual(scope.identifiers(), set(['a']))
        self.assertEqual(scope.get('a'), 1)
